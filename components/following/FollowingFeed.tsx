  ...
  return (
    <div className="ff-container">
      ...
      <div className="ff-tabs">
        <button
          className={`ff-tab${tab === "overview" ? " ff-tab-active" : ""}`}
          onClick={() => setTab("overview")}
        >
          Overview
        </button>
        <button
          className={`ff-tab${tab === "leaderboard" ? " ff-tab-active" : ""}`}
      ...
      {tab === "overview" ? (
        <>
          <div className="ff-overview-toolbar">
          ...
          {follows.length === 0 ? (
            <div className="ff-empty">
              ...
              <p className="ff-empty-text">
                Follow summoners to see their rank, win rate, and recent
                matches here. Click &quot;+ Follow a Summoner&quot; above to
                get started.
              </p>
            </div>
          ) : (
        ...
        <FollowLeaderboard follows={follows} />
      )}
    </div>
  );
}
