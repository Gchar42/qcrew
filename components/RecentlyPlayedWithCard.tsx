...
export default function RecentlyPlayedWithCard({
  ...
  return (
    <div className="profile-rank-card recently-played-with-card">
      ...
      >
        {/* Played With tab — both rendered for layout, inactive hidden */}
        <div
          style={{
            gridRow: 1,
            gridColumn: 1,
            visibility: activeTab === "played" ? "visible" : "hidden",
            minHeight: 0,
          }}
        >
          {!hasEntries ? (
        ...
        {/* Best Duos tab — stacked in same grid cell so container sizes to max of both */}
        <div
          style={{
            gridRow: 1,
            gridColumn: 1,
            visibility: activeTab === "duos" ? "visible" : "hidden",
            minHeight: 0,
          }}
        >
          {!hasDuos ? (
